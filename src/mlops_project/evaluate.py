...
# Load testset
testset_path = "data/testset/test_query.json"
chunking_metadata_path = "data/processed/chunking_metadata.json"
...
for item in testset:
    ...
    json_handler = JsonHandler(chunking_metadata_path)
    retriever = Retrieve(query=query, chunks=json_handler.dataset_str, json_chunks=json_handler.dataset_json, top_k=3, model_name="models/all-MiniLM-L6-v2", index_path=index_path)
