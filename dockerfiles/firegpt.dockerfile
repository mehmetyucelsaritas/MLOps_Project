...
LABEL authors="mehmet yucel saritas"
LABEL team="group 58"
...
ENTRYPOINT ["sh", "-c", "exec streamlit run /app/src/mlops_project/gui/gui.py --server.port=$PORT --server.address=0.0.0.0 --server.headless=true"]
